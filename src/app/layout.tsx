    ...
    >
      <body className="min-h-full flex flex-col bg-zinc-50 text-zinc-950 dark:bg-black dark:text-zinc-50">
        ...
        <nav className="sticky bottom-0 z-10 border-t border-zinc-200/70 bg-zinc-50/90 backdrop-blur dark:border-white/10 dark:bg-black/70">
          <div className="mx-auto grid w-full max-w-md grid-cols-4 gap-1 px-2 py-2 text-xs">
            <Link
              href="/"
              className="rounded-lg px-3 py-2 text-center font-medium text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-white/10"
            >
              Home
            </Link>
            <Link
